...
func build(pkg, dest, version, buildOS, buildArch string) {
	...
	timeFlag := fmt.Sprintf("-X github.com/danielnapierski/go-alt/support/app.buildTime=%s", buildTime)
	versionFlag := fmt.Sprintf("-X github.com/danielnapierski/go-alt/support/app.version=%s", version)
...
func repoName() string {
	...
	return "github.com/danielnapierski/go-alt"
