...
import (
	...
	"github.com/danielnapierski/go-alt/protocols/horizon/effects"
)
...
func TestEffectActions_Index(t *testing.T) {
	...
	t.Run("omnibus test", func(t *testing.T) {
		...
		// test streaming, regression for https://github.com/danielnapierski/go-alt/services/horizon/internal/issues/147
